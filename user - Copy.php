...
function Sign_In(){
	...
	AssignVariablesIfUserLoggedIn($viewEngine);
...
function Profile(){		
	...
	{		
		...
		/// <summary>
		/// assigning variables to the template may be desired for logged in users. such variable assignment is done by the duntion
		/// </summary>
        /// <param> </param>
		/// <returns></returns>
function AssignVariablesIfUserLoggedIn($viewEngine){
	if(User::IsLoggedIn()){
